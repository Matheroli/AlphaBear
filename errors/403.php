...
<html>
<head>
    <title>403 Permissions refusées</title>
    <link rel="shortcut icon" type="image/png" href="../assets/nope.png">
    <meta charset="utf-8">
</head>
<body>
...
<h1 class="errorcode">ERREUR 403</h1>
<div class="errortext">Cet endroit est interdit !! Passez votre chemin !</div>
<style>
    html {
    ...
    .maincontainer {
      ...
      top: -50px;
      transform: scale(0.8);
      background-image: url("https://www.blissfullemon.com/wp-content/uploads/2018/09/HauntedHouseBackground.png");
